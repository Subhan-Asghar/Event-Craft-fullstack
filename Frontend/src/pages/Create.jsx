...
const create=()=>{
  ...
  return (
    <>
      ...
      {message && (
          <div className="mb-4 p-2 text-center   text-white bg-yellow-500  rounded-lg">
            {message}
          </div>
        )}

      <div className="max-w-lg mx-auto bg-white p-8 mt-8 rounded-xl shadow-md">
        <h2 className="text-2xl font-bold text-indigo-900 mb-6 text-center">Create New Event</h2>
